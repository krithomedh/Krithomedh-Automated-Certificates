...
font=ImageFont.FreeTypeFont("fonts\SnellRoundhand-BoldScript.otf",150,encoding="unic")
font1=ImageFont.FreeTypeFont("fonts\Times New Roman Font.ttf",110,encoding="unic")
